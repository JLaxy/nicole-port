        ...
        <div className="benefit-section">
            <div className="benefit-left-side-content">
                ...
                <p className="">
                    ...
                    <span className="title-highlight">{"informative, aesthetic, or ambiance-focused"}</span>
        ...
        <div className="benefit-section">
            <div className="benefit-left-side-content">
                ...
                <p className="">
                    ...
                    <span className="title-highlight">{"absorb details at their own pace"}</span>
            ...
            <div className="benefit-right-side-content">
                ...
                <p className="">
                    ...
                    <span className="title-highlight">{"make the experience unique."}</span>
                    {" Photo slides give the audience a "}
                    <span className="title-highlight">{"chance to explore the full experience"}</span>
